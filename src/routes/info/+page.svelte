<script>
 ...
 let projects = [{year: "2025", projects: ["project-splee","project-textarium","project-studium-planetare"]},
        ...
        <img src="media/me/portrait.webp" alt="Portrait Philipp Proff" class="col-start-1 col-span-12 md:col-start-4 md:col-span-6 mb-8"/>
	<p class="col-start-1 col-span-12 md:col-start-4 md:col-span-6 flex flex-col gap-12 mb-16">
