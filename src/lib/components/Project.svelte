...
<div class="grid-8 relative mb-4 bg-background">
	...
	>
		...
		<div
			class="col-span-1 row-span-1 w-3 h-3 justify-self-end border bg-background transition-transform mt-2"
	...
	<div class="h-0 col-span-8 grid-8 gap-6 md:gap-4 overflow-hidden" class:h-full={expanded}>
		...
		<div class="col-span-8 md:col-start-2 md:col-span-5">
			<div
				class="h-0 overflow-hidden grid gap-4"
				class:-mt-2={!expanded}
				class:h-full={expanded}
			>
				{#each documentation as doc}
					<img
						...
						class="my-4 mx-auto w-full max-w-[700px]"
						loading="lazy"
					/>
				{/each}
			</div>
